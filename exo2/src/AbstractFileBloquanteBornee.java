        ...
        if(n<1) 
            throw new 
                IllegalArgumentException(
                        "AbstractFileBloquanteBornee : la capacitÃ© de la file doit Ãªtre > 0");
        else {
            /* CrÃ©ation d'un tableau pseudo-gÃ©nÃ©rique.
             * Fonctionne tant que le tableau reste "interne" Ã  la classe.
